...
# Dependency Checker for server.py
def dependency_checker():
    import os
    import sys

    dependencies = ["torch", "pydantic", "logging", "uvicorn", "os", "sys", "fastapi", "transformers", "fastapi.middleware.cors"]
    for dep in dependencies:
        try:
            __import__(dep)  # Attempt to import the module (Python) or check its existence
        except ImportError:
            print(f"Dependency {dep} is missing in /mnt/data/dump-main/dump-main/server.py!")
