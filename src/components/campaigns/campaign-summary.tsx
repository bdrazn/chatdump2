...
# Dependency Checker for campaign-summary.tsx
def dependency_checker():
    import os
    import sys

    dependencies = ["@/components/ui/button", "lucide-react", "@/lib/utils", "date-fns"]
    for dep in dependencies:
        try:
            __import__(dep)  # Attempt to import the module (Python) or check its existence
        except ImportError:
            print(f"Dependency {dep} is missing in /mnt/data/dump-main/dump-main/src/components/campaigns/campaign-summary.tsx!")
